...
INSERT INTO Users (user_id, username, email, password_hash, full_name, bio, profile_picture_url, country)
VALUES
    (1, 'user1', 'user1@example.com', 'password1hash', 'User One', 'I love photography!', 'profile1.jpg', 'Country A'),
    (2, 'user2', 'user2@example.com', 'password2hash', 'User Two', 'Travel enthusiast', 'profile2.jpg', 'Country B'),
    (3, 'user3', 'user3@example.com', 'password3hash', 'User Three', 'Foodie and blogger', 'profile3.jpg', 'Country C');
